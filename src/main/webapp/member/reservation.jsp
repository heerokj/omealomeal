...
<div id="contain">
	...
	<input type="hidden" name="store_num" value="<%=store %>">
	<div class="headcount">
	...
	<div class="date">
		<label>날짜</label> <input type="date" name="rez_date" class="datebox" id="datebox"/>
	</div>
	<div class="time">
	...
	<div class="requests">
		<label>요청사항</label>
		<textarea name="memo" class="request_box" placeholder="요청사항을 입력해주세요." id="req"></textarea>
	</div>
	<div class="rezterms">
